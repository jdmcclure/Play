	...
	sql_query = """
		...
		SELECT 
			...
			CASE
				...
				WHEN IncidentOffense.ViolationCodeReference_Description LIKE '%RAPE%' THEN 'Rape'
				WHEN IncidentOffense.ViolationCodeReference_Description LIKE '%FONDLING%' THEN 'Fondling'
				WHEN IncidentOffense.ViolationCodeReference_Description LIKE '%UNLAWFUL SEXUAL CONTACT%' THEN 'Fondling'
				WHEN IncidentOffense.ViolationCodeReference_Description LIKE '%INVASION OF PRIVACY%' THEN 'Invasion of Privacy'
				...
				WHEN IncidentOffense.ViolationCodeReference_Description LIKE '%UICID%' THEN 'Death Investigation'
